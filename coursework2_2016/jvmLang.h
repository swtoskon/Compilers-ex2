...
{
   if (Arg1 == type_integer) {printf("i");}
   if (Arg1 == type_real) {printf("f");}
}
...
/* Creating a label (outputing in console) with a
 specific label that you pass as a parameter. If the label is greater that 0.
